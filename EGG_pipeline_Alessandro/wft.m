    ...
    function parcalc(racc)
        ...
        if ~isempty(fwt) %if the frequency-domain form is known
            ...
            if abs(wp.ompeak)>10^(-12) %center around the peak if needed
                if ~strcmpi(DispMode,'off') %ŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹ
                    fprintf(2,'--------------------------------------------- Warning! ---------------------------------------------\n');
            ...
            [QQ,wflag,xx,ss]=sqeps(vfun,xp,[lim1,lim2],racc,MIC,...
                [-8*(2*pi*fs),8*(2*pi*fs)]); %ŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹ
            ...
            if wflag==1 && ~strcmpi(DispMode,'off') %ŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹ
                fprintf(2,'--------------------------------------------- Warning! ---------------------------------------------\n');
            ...
            if isempty(wp.omg) %ŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹ
            ...
            if isempty(twf) %if time domain form is not known
                [PP,wflag,xx,ss]=sqeps(@(x)abs(fwt(x)).^2,wp.ompeak,[wp.xi1,wp.xi2],racc,MIC,...
                    [-8*(2*pi*fs),8*(2*pi*fs)]); %ŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹ
                Etot=sum(PP(1,:))/2/pi;
                ...
                if (abs(Etot-Eest)+Iest1+Iest2)/Etot>0.01 && ~strcmpi(DispMode,'off') %ŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹ
                    fprintf(2,'--------------------------------------------- Warning! ---------------------------------------------\n');
        ...
        if ~isempty(twf) %if the time-domain form is known
            ...
            if isempty(fwt) %if frequency domain form is not known
                [PP,wflag,xx,ss]=sqeps(@(x)abs(twf(x)).^2,wp.tpeak,[wp.t1,wp.t2],racc,MIC,...
                    [-8*L/fs,8*L/fs]); %ŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹ
                Etot=sum(PP(1,:));
                ...
                if isempty(wp.C) %ŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹ
                    wp.C=pi*twf(0);
                    if isnan(wp.C), wp.C=pi*twf(10^(-14)); end
                end
                if isempty(wp.omg) %ŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹ
            ...
            [QQ,wflag,xx,ss]=sqeps(vfun,xp,[lim1,lim2],racc,MIC,...
                [-8*L/fs,8*L/fs]); %ŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹ
